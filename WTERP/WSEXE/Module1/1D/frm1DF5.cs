...
namespace WTERP
{
    public partial class Form1DF5 : Form
    {
        ...
        private void getData()
        {
            ...
            DL.t60 = dataForm1DF5.Rows[dataForm1DF5.CurrentRow.Index].Cells["USR_NAME"].Value.ToString();
        ...
        public void search()
        {
            ...
            sql = "select TOP 100 PROD1C.K_NO, KIND1C.K_NAME, C_NO, K_NO_O, DEPT, P_NO, P_NAME, P_NAME1, P_NAME2, P_NAME3, UNIT, TRANS, BUNIT, CUNIT, PRICE, QDATE, M_TRAN, W_CHECK, QTYSTORE, QTYSAF, P_WEG, QTYSTORE_B, QTYSTORE_BB, BASEDATE, INDATE, OUTDATE, PLACE, MEMO1, MEMO2, MEMO3, MEMO4, PRICE1, PRICE2, PRICE4, " +
                " QTY01, PRICE5, PRICE6, PRICE7, PRICE8, PRICE3, DKIND, QDATE1, QDATE2, QDATE4, QDATE5, QDATE6, QDATE7, QDATE8, QDATE3, COST, COST_AVG, COST_NEW from dbo.PROD1C,USR_NAME LEFT JOIN KIND1C ON PROD1C.K_NO = KIND1C.K_NO WHERE 1=1";
