...
namespace WTERP
{
    public partial class Form1DF7 : Form
    {
        ...
        {
            tb1t1.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb2t1.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb7t1.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb8t1.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb4t2.Text = Form1BF5.GU.s1;
        }

        private void tb4t2_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            tb1t3.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb2t3.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb3t4.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb4t4.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb1t5.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb2t5.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb1t6.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb2t6.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb1t7.Text = FormSeachKIND.DL.K_NO;
        }
        ...
        {
            tb2t7.Text = FormSeachKIND.DL.K_NO;
        }
