...
namespace WTERP
{
    public partial class Form1E : Form
    {
        ...
        public void LoadData()
        {
            ...
            cm.CommandText = "select K_NO, K_NAME,USR_NAME from KIND";
            ...
            //ẩn cột
            this.dataGridViewkhothanhpham.Columns["USR_NAME"].Visible = false;
        }
        ...
        public void hienthi()
        {
            ...
            lblEditBy.Text = dataGridViewkhothanhpham.Rows[0].Cells["USR_NAME"].Value.ToString();
        }
        public void hienthi2()
        {
            ...
            this.lblEditBy.Text = dataGridViewkhothanhpham.Rows[dataGridViewkhothanhpham.CurrentRow.Index].Cells[2].Value.ToString();
        }
        ...
        private void btok_Click(object sender, EventArgs e)
        {
            ...
            {
                string a = tb1.Text;
                string SQL = "select K_NO from KIND where K_NO = '" + a + "'";
                ...
                con.Open();
                string st1 = "insert into dbo.KIND(K_NO, K_NAME,USR_NAME) values(@K_NO, @K_NAME,@USR_NAME)";
            ...
            else if (f4ToolStripMenuItem.Checked == true)
            {
                con = new SqlConnection(st);
                con.Open();
                string st1 = "update dbo.KIND set K_NO = @K_NO, K_NAME = @K_NAME,USR_NAME = @USR_NAME where K_NO = @K_NO";
