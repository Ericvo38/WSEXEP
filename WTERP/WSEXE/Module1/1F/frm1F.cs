...
namespace WTERP
{
    public partial class Form1F : Form
    {
        ...
        public void LoadData()
        {
            ...
            cm.CommandText = "select K_NO, K_NAME, PACK_NO, CUNO,USR_NAME from KIND1C";
            ...
            //ẩn cột
            this.dataGridViewForm1F.Columns["USR_NAME"].Visible = false;
        }
        public void hienthi()
        {
            ...
            lblEditBy.Text = dataGridViewForm1F.Rows[0].Cells["USR_NAME"].Value.ToString();
        }
        public void hienthi2()
        {
            ...
            this.lblEditBy.Text = dataGridViewForm1F.Rows[dataGridViewForm1F.CurrentRow.Index].Cells[4].Value.ToString();
        ...
        private void btok_Click(object sender, EventArgs e)
        {
            if (f2ToolStripMenuItem.Checked == true)
            {
                checkNofication();
                string a = tb1.Text;
                string SQL = "select K_NO from KIND1C WHERE K_NO = '" + a + "'";
                ...
                con.Open();
                string st1 = "insert into dbo.KIND1C(K_NO, K_NAME, PACK_NO, CUNO,USR_NAME) values(@K_NO, @K_NAME, @PACK_NO, @CUNO,@USR_NAME)";
            ...
            else if (f4ToolStripMenuItem.Checked == true)
            {
                con = new SqlConnection(st);
                con.Open();
                string st1 = "update dbo.KIND1C set K_NO = @K_NO, K_NAME = @K_NAME , PACK_NO = @PACK_NO, CUNO = @CUNO,USR_NAME = @USR_NAME where K_NO = @K_NO";
                SqlCommand cm = new SqlCommand(st1, con);
