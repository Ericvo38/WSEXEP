...
namespace WTERP
{
    public partial class frm1IF7_Tab1_4 : Form
    {
        DataProvider conn = new DataProvider();
        public frm1IF7_Tab1_4()
        {
        ...
        private void expoxrt_excel(string workbookPath, string filePath)
        {
            ...
            else
            {
                ...
                COMExcel.Range Na1 = IV.get_Range("E7", "H7");
                Na1.Value2 = DateTime.Now.ToString("dd/MM/yyyy");

                COMExcel.Range Na2 = IV.get_Range("B8", "G8");
                ...
                COMExcel.Range Na5 = IV.get_Range("K8", "M8");
                Na5.Value2 = dt.Rows[0]["C_NO"].ToString();

                COMExcel.Range Na6 = IV.get_Range("K9", "M9");
                ...
                foreach (DataRow item in dt.Rows)
                {
                    ...
                    COMExcel.Range PhanTram = IV.get_Range("L" + a, "L" + a);
                    PhanTram.VerticalAlignment = Microsoft.Office.Interop.Excel.XlVAlign.xlVAlignCenter;
                    PhanTram.HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
                    PhanTram.Value2 = item["AGVCQ"].ToString() + "%";

                    a++;
                }
                conn.BorderAround(IV.get_Range("A13", "M" + (a - 1)));
        ...
        private void ExportExcel_Click(object sender, EventArgs e)
        {
            ...
            string workbookPath = conn.LinkTemplate + "1I_Tab1_4.xls";
            string filePath = conn.LinkTemplate_SAVE + "1I_Tab1_4.xls";
        ...
        private void frm1IF7_Tab1_4_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_Form1I_Tab1_4 rpt = new WSEXE.ReportView.cr_Form1I_Tab1_4();
            dt = conn.readdata(st);
