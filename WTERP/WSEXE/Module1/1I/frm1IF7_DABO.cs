...
namespace WTERP
{
    public partial class frm1IF7_DABO : Form
    {
        public frm1IF7_DABO()
        {
        ...
        private void frm1IF7_DABO_Load(object sender, EventArgs e)
        {
            ...
            st = "select QUOH.WS_NO, QUOH.C_NO, QUOH. C_NAME, QUOH.SPEAK, QUOH.SPEAK_CC, QUOH.MEMO1, QUOH.MEMO2, QUOH.MEMO3, QUOH.MEMO4, QUOH.MEMO5, QUOH.MEMO6, QUOH.MEMO101, QUOH.MEMO102, QUOH.MEMO103, QUOH.MEMO104, QUOH.MEMO105, QUOH.MEMO106, QUOH.MEMO107, QUOH.MEMO108, QUOH.MEMO109, QUOH.MEMO110, " +
                    ...
                    " QUOH.PAY_COND, QUOH.PS01, QUOB.P_NO, QUOB.P_NAME, QUOB.P_NAME1, QUOB.PBT01, QUOB.PBT03, QUOB.PBT02, QUOB.P_NAME3, QUOB.PRICE from QUOH JOIN QUOB ON QUOH.WS_NO = QUOB.WS_NO where QUOH.WS_NO = '" + S + "' ";


            WSEXE.ReportView.cr_Form1I_Tab1_Dabo rpt = new WSEXE.ReportView.cr_Form1I_Tab1_Dabo();
