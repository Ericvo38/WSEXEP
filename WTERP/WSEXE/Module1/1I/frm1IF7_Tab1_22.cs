...
namespace WTERP
{
    public partial class frm1IF7_Tab1_22 : Form
    {
        DataProvider connect = new DataProvider();
        public frm1IF7_Tab1_22()
        {
        ...
        private void ExportExcel_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= dt.Rows.Count - 1; i++)
            {
                ...
                P_NAME.Merge();
                P_NAME.Value2 = dt.Rows[i]["P_NAME1"].ToString();
            ...
            connect.BorderAround(IV.get_Range("A14", "I" + (13 + dt.Rows.Count)));
        ...
        private void frm1IF7_Tab1_22_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_Form1I_Tab1_22 rpt = new WSEXE.ReportView.cr_Form1I_Tab1_22();
