...
namespace WTERP
{
    public partial class frm2K_Tap1_8TQ : Form
    {
        DataProvider con = new DataProvider();

        public frm2K_Tap1_8TQ()
        {
            this.ShowInTaskbar = false;
            InitializeComponent();
        }

        private void frm2K_Tap1_8TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_8_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_8_TQ();
