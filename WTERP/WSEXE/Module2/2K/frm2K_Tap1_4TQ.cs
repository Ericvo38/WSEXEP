...
namespace WTERP
{
    public partial class frm2K_Tap1_4TQ : Form
    {
        public frm2K_Tap1_4TQ()
        {
        ...
        private void frm2K_Tap1_4TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_4_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_4_TQ();
