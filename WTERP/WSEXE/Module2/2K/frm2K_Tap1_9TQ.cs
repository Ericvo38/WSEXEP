...
namespace WTERP
{
    public partial class frm2K_Tap1_9TQ : Form
    {
        public frm2K_Tap1_9TQ()
        {
            this.ShowInTaskbar = false;
            InitializeComponent();
        }
        DataProvider con = new DataProvider();
        private void frm2K_Tap1_9TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_9_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_9_TQ();
