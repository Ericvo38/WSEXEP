...
namespace WTERP
{
    public partial class frm2K_Tap1_8 : Form
    {
        public frm2K_Tap1_8()
        {
        ...
        private void frm2K_Tap1_8_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_8 rpt = new WSEXE.ReportView.cr_From2K_Tap1_8();
