...
namespace WTERP
{
    public partial class frm2K_Tap1_6 : Form
    {
        public frm2K_Tap1_6()
        {
        ...
        private void frm2K_Tap1_6_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_6 rpt = new WSEXE.ReportView.cr_From2K_Tap1_6();
