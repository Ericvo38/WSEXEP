...
namespace WTERP
{
    public partial class frm2K_Tap1_7 : Form
    {
        public frm2K_Tap1_7()
        {
        ...
        private void frm2K_Tap1_7_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_7 rpt = new WSEXE.ReportView.cr_From2K_Tap1_7();
