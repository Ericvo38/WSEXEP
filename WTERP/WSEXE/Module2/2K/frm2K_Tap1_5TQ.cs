...
namespace WTERP
{
    public partial class frm2K_Tap1_5TQ : Form
    {
        public frm2K_Tap1_5TQ()
        {
        ...
        private void frm2K_Tap1_5TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_5_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_5_TQ();
