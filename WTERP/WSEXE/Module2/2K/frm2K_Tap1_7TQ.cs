...
namespace WTERP
{
    public partial class frm2K_Tap1_7TQ : Form
    {
        public frm2K_Tap1_7TQ()
        {
        ...
        private void frm2K_Tap1_7TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_7_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_7_TQ();
