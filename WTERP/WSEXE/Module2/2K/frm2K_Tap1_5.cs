...
namespace WTERP
{
    public partial class frm2K_Tap1_5 : Form
    {
        public frm2K_Tap1_5()
        {
        ...
        private void frm2K_Tap1_5_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_5 rpt = new WSEXE.ReportView.cr_From2K_Tap1_5();
