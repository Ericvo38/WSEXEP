...
namespace WTERP
{
    public partial class frm2K_Tap1_4 : Form
    {
        public frm2K_Tap1_4()
        {
        ...
        private void frm2K_Tap1_4_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_4 rpt = new WSEXE.ReportView.cr_From2K_Tap1_4();
