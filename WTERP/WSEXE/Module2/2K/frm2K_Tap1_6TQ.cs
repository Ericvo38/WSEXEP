...
namespace WTERP
{
    public partial class frm2K_Tap1_6TQ : Form
    {
        public frm2K_Tap1_6TQ()
        {
        ...
        private void frm2K_Tap1_6TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_6_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_6_TQ();
