...
namespace WTERP
{
    public partial class frm2K_Tap1_2TQ : Form
    {
        public frm2K_Tap1_2TQ()
        {
        ...
        private void frm2K_Tap1_2TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_2_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_2_TQ();
