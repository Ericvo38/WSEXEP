...
namespace WTERP
{
    public partial class frm2K_Tap1_1TQ : Form
    {
        ...
        private void frm2K_Tap1_1TQ_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    dr["AMOUNT"] = double.Parse(Math.Round(decimal.Parse(dr["AMOUNT"].ToString()), 2).ToString());
                }
            }

            WSEXE.ReportView.cr_From2K_Tap1_1TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_1TQ();
        ...
        private DataTable ReturnDataCATH(DataTable data)
        {
            ...
            if (data.Rows.Count > 0)
            {
                ...
                //AMOUNT_CATH = string.Format("{0:0,##0.00}", float.Parse(data.Rows[0]["RCVTOT"].ToString()).ToString());
            }
            return data;
        }
        private DataTable ReturnDataCATB(string key22, string key23, DataTable data2)
        {
            ...
            foreach (DataRow dr in data2.Rows)
            {
                ...
                PRICE_NEW = string.Format("{0:0,##0.00}", float.Parse(data2.Rows[0]["PRICE"].ToString()).ToString());
                BQTY_NEW = string.Format("{0:0,##0.00}", float.Parse(data2.Rows[0]["BQTY"].ToString()).ToString());
                AMOUNT_NEW = string.Format("{0:0,##0.00}", float.Parse(data2.Rows[0]["AMOUNT"].ToString()).ToString());
        ...
        private void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < page; i++)
            {
                ...
                COMExcel.Range Na1 = IV.get_Range("A" + rowex, "O" + (rowex + 5));
                Na1.Merge();
                Na1.Value2 = "請 款 對 帳 單";
                Na1.Cells.Font.FontStyle = "標楷體";
                Na1.Font.Underline = true;
                Na1.Font.Size = 28;
                Na1.Font.Bold = true;

                Na1.HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;

                COMExcel.Range Na13 = IV.get_Range("A" + (rowex + 7), "o" + (rowex + 7));
                Na13.Merge();
                ...
                Na15.RowHeight = 20;
                //Na15.Cells.Font.FontStyle = "標楷體";
                Na15.Value2 = "幣別: " + dt.Rows[0]["M_TRAN"].ToString();

                COMExcel.Range Na15_1 = IV.get_Range("L" + (rowex + 8), "O" + (rowex + 8));
                Na15_1.Merge();
                ...
                Na15_1.RowHeight = 20;
                Na15_1.Font.Bold = true;
                //Na15_1.Cells.Font.FontStyle = "標楷體";
                ...
                // Na23.Cells.Font.FontStyle = "細明體";
                Na23.Value2 = "金額";

                COMExcel.Range Na24 = IV.get_Range("O" + (rowex + 9), "O" + (rowex + 9));
                Na24.Value2 = "備註";
                //Na24.Cells.Font.FontStyle = "細明體";
                ...
                for (int j = rowList; j < pagenumber; j++)
                {
                    if (indexrow < dt.Rows.Count)
                    {
                        ...
                        // Detail4.Cells.Font.FontStyle = "細明體";
                        ...
                        //Detail5.Cells.Font.FontStyle = "細明體";
                        ...
                        // Detail6.Cells.Font.FontStyle = "細明體";
                        ...
                        //Detail7.Cells.Font.FontStyle = "細明體";
                        ...
                        // Detail8.Cells.Font.FontStyle = "細明體";
                ...
                if (i == page - 1)
                {
                    COMExcel.Range title = IV.get_Range("E" + (rowex + 10), "E" + (rowex + 10));
                    title.Merge();
                    ...
                    sum1.Value2 = dt.AsEnumerable().Sum(x => x.Field<double>("AMOUNT"));
                     ...
                     if (da2.Rows.Count > 0)
                    {
                        COMExcel.Range title2 = IV.get_Range("E" + (rowex + 11), "F" + (rowex + 11));
                        title2.Merge();
                        ...
                        COMExcel.Range sumCATH = IV.get_Range("L" + (rowex + 11), "N" + (rowex + 11));
                        sumCATH.Merge();
                        ...
                        COMExcel.Range WS = IV.get_Range("A" + (rowex + 12), "A" + (rowex + 12));
                        WS.Merge();
                        WS.WrapText = true;
                        WS.Font.Bold = true;
                        WS.NumberFormat = "@";
                        ...
                        COMExcel.Range WS_NO = IV.get_Range("B" + (rowex + 12), "D" + (rowex + 12));
                        WS_NO.Merge();
                        WS_NO.WrapText = true;
                        ...
                        COMExcel.Range P_NAME = IV.get_Range("E" + (rowex + 12), "F" + (rowex + 12));
                        P_NAME.Merge();
                        ...
                        COMExcel.Range P_NAME3 = IV.get_Range("G" + (rowex + 12), "G" + (rowex + 12));
                        P_NAME3.Merge();
                        ...
                        COMExcel.Range BQTY = IV.get_Range("H" + (rowex + 12), "J" + (rowex + 12));
                        BQTY.Merge();
                        BQTY.WrapText = true;
                        BQTY.Font.Bold = true;
                        ...
                        COMExcel.Range PRICE = IV.get_Range("K" + (rowex + 12), "K" + (rowex + 12));
                        PRICE.Merge();
                        PRICE.WrapText = true;
                        ...
                        COMExcel.Range AMOUNT = IV.get_Range("L" + (rowex + 12), "N" + (rowex + 12));
                        AMOUNT.Merge();
                        ...
                        COMExcel.Range MEMO = IV.get_Range("O" + (rowex + 12), "P" + (rowex + 12));
                        MEMO.Merge();
                        MEMO.WrapText = true;
                        MEMO.Font.Bold = true;
                        MEMO.Font.Size = 10;
                        ...
                        COMExcel.Range title32 = IV.get_Range("E" + (rowex + 13), "F" + (rowex + 13));
                        title32.Merge();
                        title32.Font.Bold = true;
                        title32.Font.Size = 10;
                        title32.Value2 = "湓收少收小計";

                        COMExcel.Range AMOUNT2 = IV.get_Range("L" + (rowex + 13), "N" + (rowex + 13));
                        AMOUNT2.Merge();
                        ...
                        COMExcel.Range title3 = IV.get_Range("E" + (rowex + 14), "F" + (rowex + 14));
                        title3.Merge();
                        title3.Font.Bold = true;
                        title3.Font.Size = 10;
                        title3.Value2 = "合  計";

                        COMExcel.Range AMOUNT3 = IV.get_Range("L" + (rowex + 14), "N" + (rowex + 14));
                        AMOUNT3.Merge();
                        AMOUNT3.WrapText = true;
                        AMOUNT3.Font.Bold = true;
                        AMOUNT3.NumberFormat = "#,##0.00";
                        AMOUNT3.Font.Size = 12;
                        AMOUNT3.Value2 = float.Parse(AMOUNT_CATH.ToString())  + float.Parse(AMOUNT_NEW.ToString());

                        if (frm2K.rd_HN == false)
                        {
                            COMExcel.Range title4 = IV.get_Range("E" + (rowex + 15), "F" + (rowex + 15));
                            title4.Merge();
                            title4.Font.Bold = true;
                            title4.Font.Size = 10;
                            title4.Value2 = "差 異";

                            COMExcel.Range AMOUNT4 = IV.get_Range("L" + (rowex + 15), "N" + (rowex + 15));
                            AMOUNT4.Merge();
                        ...
                        {
                            COMExcel.Range Na2523 = IV.get_Range("A" + (rowex + 15), "P" + (rowex + 15));
                            Na2523.Merge();
                            Na2523.Font.Bold = true;
                            Na2523.Font.Size = 10;
                            Na2523.Value2 = "  核准:___________   覆核:___________   主管:___________   業務會計:___________   製單: " + user_name + "";
                ...
                BorderAround1 = BorderAround1 + 46;
