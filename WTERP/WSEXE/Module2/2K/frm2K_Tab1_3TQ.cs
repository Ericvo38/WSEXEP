...
namespace WTERP
{
    public partial class frm2K_Tab1_3TQ : Form
    {
        public frm2K_Tab1_3TQ()
        {
        ...
        private void frm2K_Tab1_3TQ_Load(object sender, EventArgs e)
        {
            ...
            WSEXE.ReportView.cr_From2K_Tap1_3_TQ rpt = new WSEXE.ReportView.cr_From2K_Tap1_3_TQ();
