...
namespace WTERP
{
    public partial class frm2EF6 : Form
    {
        ...
        public static string Share_C_NO = string.Empty;
        ...
        {
            string SQL = "SELECT Top 100 NR, OR_NO,C_NO,C_NAME_E, COLOR_E,dbo.FormatString1(WS_DATE) AS WS_DATE,P_NAME_E,THICK,QTY,P_NO,K_NO,PATT_C,PATT_E,MODEL_E FROM ORDB WHERE  C_NO = '" + MaKH + "' ORDER BY WS_DATE DESC, NR DESC, OR_NO DESC";
        ...
        void Search()
        {
            ...
            if (txtDate.MaskCompleted) SQL1 = SQL1 + " AND WS_DATE LIKE '%" + txtDate.Text.Replace("/","")+ "%' ";
