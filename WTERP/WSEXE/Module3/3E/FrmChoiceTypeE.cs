...
{
    public partial class FrmChoiceTypeE : Form
    {
        public FrmChoiceTypeE()
        {
            InitializeComponent();
        }

        private void FrmChoiceTypeE_Load(object sender, EventArgs e)
        {
            LoadLanguage();
            Form3E.Share_Type = string.Empty;
        }
