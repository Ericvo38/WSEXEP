...
{
    public partial class frm3P_F6 : Form
    {
        ...
        {
            string sql = "SELECT DATECREATE,INVOICE,C_NO,USER_NAME,BUYER FROM tblPackingList_Type2 WHERE 1=1 ORDER BY DATECREATE DESC";
        ...
        {
            string sql = "SELECT * FROM dbo.tblDescription_PackingList_Type2 WHERE INVOICE = '" + txtInvoice + "'";
            DataTable data = new DataTable();
            data = conn.readdata(sql);
        ...
        private void search()
        {
            string sql = "SELECT DATECREATE,INVOICE,C_NO,USER_NAME,BUYER FROM tblPackingList_Type2 WHERE 1=1";
        ...
        {
            DL3PF6.INVOICE = DGV1.CurrentRow.Cells["INVOICE"].Value.ToString();
            this.Hide();
            this.Close();
        }
        public class DL3PF6
